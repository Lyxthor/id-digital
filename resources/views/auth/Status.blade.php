...
<div id="sidebar" class="fixed z-10 inset-y-0 left-0 bg-[#124868] w-64 shadow-lg transform -translate-x-full transition-transform duration-300">
  ...
  <!-- Navbar / Header -->
  <header class="bg-[#19456B] text-white rounded-b-3xl p-6 flex items-center justify-between transition-all duration-300">
    <!-- Hamburger Icon -->
  ...
  <main id="mainContent" class="p-6 space-y-6 transition-all duration-300">
    ...
    <div class="flex items-start space-x-4">
      ...
      <div>
        <h3 class="text-sm font-semibold">Data sedang diproses</h3>
        <p class="text-sm text-gray-500">Dokumen sedang diproses</p>
      </div>
    </div>
  </main>
