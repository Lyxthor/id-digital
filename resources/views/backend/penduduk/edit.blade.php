    ...
    <section class="bg-white shadow rounded-lg p-6">
      ...
      <form id="penduduk-form">
        <div class="mb-4">
          ...
          <input type="text" id="first-name" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" value="Ilham" required>
        </div>
        <div class="mb-4">
          <label for="last-name" class="block text-sm font-medium">Last Name</label>
          <input type="text" id="last-name" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" value="Ghozali" required>
        </div>
        <div class="mb-4">
        ...
        {{-- <div class="mb-4">
          ...
          <textarea id="description" rows="3" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" value="" required></textarea>
        </div> --}}
        <div class="flex justify-end space-x-2">
          <button type="reset" class="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400">Reset</button>
          <button type="submit" class="px-4 py-2 bg-[#124868] text-white rounded hover:bg-blue-600">Update</button>
        </div>
      </form>
    </section>
  </main>
