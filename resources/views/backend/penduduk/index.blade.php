    ...
    <main class="flex-1 bg-gray-50 p-8">
        <div class="container mx-auto">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-custom-blue">Master Penduduk</h1>
                <a href="{{ route('addMasterPendudukPage') }}" class="bg-custom-blue text-white px-4 py-2 rounded">Add Master Penduduk</a>
            </div>
                    ...
                    <tbody>
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b border-gray-200">
                                    <a href="{{ route('editMasterPendudukPage') }}" class="bg-yellow-500 text-white px-4 py-2 rounded">Edit</a>
